...
DEFAULT_PREY_GENERATION_POPULATION = 20
...
class NaturaNet:
    ...
    def startNewGeneration(self):
        ...
        self.predators = []
        self.food = [Food(random, (self.width, self.height), DEFAULT_CELL_SIZE) for _ in range(40)]
    ...
    def update(self):
        ...
        if self.clockTickCounter % 5 == 0:
            for prey in self.prey:
                ...
                prey.movement(prey.findNearestFruit(self.cells)[1]  , random.randint(0,10), self.cells)
    ...
    def draw(self):
        ...
        for prey in self.prey:
            pygame.draw.rect(self.display, (0,0,255), (prey.x, prey.y, Prey.size, Prey.size))
